...
public class GameOverScreen implements Screen {
	...
	public void show() {
		...
		playAgainButtonEllipse = new Ellipse((Constants.WORLD_WIDTH - playAgainButton.getWidth()) / 2, 325, playAgainButton.getWidth(), playAgainButton.getHeight());
		menuButtonEllipse = new Ellipse((Constants.WORLD_WIDTH - menuButton.getWidth()) / 2, 250, menuButton.getWidth(), menuButton.getHeight());
	}
